...
export default function CTA() {
    return (
        <div className='px-4'>
            <section className='relative max-w-5xl rounded-2xl w-full mx-auto flex flex-col gap-6 items-center py-16 lg:py-20 mb-24 px-4 md:px-8 scroll-my-20 overflow-hidden shadow-sm border' id="cta">
