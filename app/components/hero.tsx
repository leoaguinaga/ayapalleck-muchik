...
export default function Hero() {
    return (
        <div className='flex flex-col gap-4 items-center pt-28 md:pt-32 pb-12 md:pb-20 px-4 xl:px-0 relative z-0'>
            ...
            <h1 className='font-bebas-neue text-4xl md:text-5xl max-w-2xl text-center font-black'>El PMS que convierte tu operación en <span className='text-blue-600 dark:text-blue-400 italic'>precisión</span></h1>
            ...
            <img src="/hero.png" className='w-full max-w-5xl object-cover rounded-xl mt-8' alt="" />
        </div>
    )
}
