...
export default function Header() {
    return (
        <div className='w-full fixed top-0 z-50 backdrop-blur-2xl bg-white/80'>
            <section className='max-w-6xl mx-auto flex justify-between py-2 font-medium'>
                ...
                <div className='gap-4 flex items-center'>
                    <Link href="/login" className='hover:underline underline-offset-4'>Iniciar sesión</Link>
