...
export default function BookingNavbar({ weekOffset, onPrevWeek, onNextWeek }: BookingNavbarProps) {
  return (
    <div className="flex flex-col relative xs:flex-row gap-2 justify-between w-full xs:items-center p-4 rounded-xl bg-card">
      <div className="p-0.75 rounded-lg items-center flex gap-1 bg-gray-200/80 dark:bg-muted w-fit text-sm font-medium">
        <Link
          href="/bookings"
          className="px-2 py-1 bg-white dark:bg-background rounded-md shadow-sm"
        >
          General
        </Link>
