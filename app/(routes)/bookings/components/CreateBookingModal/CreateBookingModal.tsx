      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto p-4 sm:p-6">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs sm:text-sm">
            Registra una nueva reserva para la habitación{" "}
            {roomNumber || "seleccionada"}
          </DialogDescription>
        </DialogHeader>
                ...
                render={({ field }) => (
                  <FormItem className="w-full">
                    <FormLabel className="text-xs sm:text-sm">
                      Selecciona el huésped
                    </FormLabel>
                    <FormControl>
                      <CustomerSelector
                        value={field.value}
                        onChange={(value) => field.onChange(value)}
                        customers={mockGuests.map((g) => ({
                          id: g.id,
                          name: g.name,
                          document: g.document,
                        }))}
                    ...
                    <p className="text-xs text-muted-foreground">
                      ...
                      >
                        <FormCreateCustomer
                          setOpenModalCreateCustomer={setOpenCreateGuestModal}
                        />
                      </CustomOpenModalButton>
                    </p>
