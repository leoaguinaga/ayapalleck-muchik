...
import { Siren, UserCircle } from "lucide-react"
...
export default function ConfigurationsTabs(props: ConfigurationTabsProps) {
  ...
  return (
    <Tabs defaultValue={tab} className="sm:flex sm:flex-row items-center sm:items-start gap-0 m-0">
      <TabsList className="flex flex-row sm:flex-col gap-1 p-2.5 bg-background items-start w-50 h-fit">
      ...
      <div className="border-0 border-r sm:min-h-full min-w-full sm:min-w-fit"></div>
